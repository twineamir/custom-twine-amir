...
const actions = module.exports = {
	...
	createPassageA({ dispatch }, storyId, props) {
		dispatch('CREATE_PASSAGEA_IN_STORY', storyId, props);
	},
	createPassageX({ dispatch }, storyId, props) {
		dispatch('CREATE_PASSAGEX_IN_STORY', storyId, props);
	},
	createPassageZ({ dispatch }, storyId, props) {
		dispatch('CREATE_PASSAGEZ_IN_STORY', storyId, props);
	},
	createPassageS({ dispatch }, storyId, props) {
		dispatch('CREATE_PASSAGESAME_IN_STORY', storyId, props);
	},
	createPassageU({ dispatch }, storyId, props) {		
		dispatch('CREATE_PASSAGEU_IN_STORY', storyId, props);
	},
	createPassageL({ dispatch }, storyId, props) {
		dispatch('CREATE_PASSAGEL_IN_STORY', storyId, props);
	},
	updatePassage({ dispatch }, storyId, passageId, props) {
		dispatch('UPDATE_PASSAGE_IN_STORY', storyId, passageId, props);
	},
	updatePassageA({ dispatch }, storyId, passageId, props) {
		dispatch('UPDATE_PASSAGE_IN_STORY', storyId, passageId, props);
	},
	updatePassageX({ dispatch }, storyId, passageId, props) {
		dispatch('UPDATE_PASSAGE_IN_STORY', storyId, passageId, props);
	},
	updatePassageU({ dispatch }, storyId, passageId, props) {
		dispatch('UPDATE_PASSAGE_IN_STORY', storyId, passageId, props);
	},
	updatePassageL({ dispatch }, storyId, passageId, props) {
		dispatch('UPDATE_PASSAGE_IN_STORY', storyId, passageId, props);
	},
	deletePassage({ dispatch }, storyId, passageId) {
		dispatch('DELETE_PASSAGE_IN_STORY', storyId, passageId);
	},
	deletePassages({ dispatch }, storyId, passageId) {
		dispatch('DELETE_PASSAGES_IN_STORY', storyId, passageId);
	},
	...
	*/
	...
	createNewlyLinkedPassagesA(store, storyId, passageId, oldText, gridSize) {
		const story = store.state.story.stories.find(
			story => story.id === storyId
		);
		const passage = story.passages.find(
	...
	createNewlyLinkedPassagesZ(store, storyId, passageId, oldText, gridSize) {
		const story = store.state.story.stories.find(
			story => story.id === storyId
		);
		const passage = story.passages.find(
	...
	createNewlyLinkedPassagesS(store, storyId, passageId, oldText, gridSize) {
		const story = store.state.story.stories.find(
			story => story.id === storyId
		);
		const passage = story.passages.find(
	...
	createNewlyLinkedPassagesU(store, storyId, passageId, oldText, gridSize) {
		const story = store.state.story.stories.find(
			story => story.id === storyId
		);
		const passage = story.passages.find(
	...
	createNewlyLinkedPassagesL(store, storyId, passageId, oldText, gridSize) {
		const story = store.state.story.stories.find(
			story => story.id === storyId
		);
		const passage = story.passages.find(
